...
STRINGS = {
    "en": {
        ...
        "search_btn":       "Find Recommendations",
        "searching":        "🔍 Searching...",
        ...
        "anomaly_warning":  "⚠️ Your query is quite unusual — no strong matches found. Try mentioning a specific show.",
        "tab_chat":         "💬 Recommend",
    ...
    "he": {
        ...
        "anomaly_warning":  "⚠️ השאילתה שלך חריגה מאוד — לא נמצאו התאמות חזקות. נסה לציין סדרה ספציפית.",
        "tab_chat":         "💬 המלצות",
        "tab_research":     "📊 מחקר",
        "tab_about":        "ℹ️ אודות",
